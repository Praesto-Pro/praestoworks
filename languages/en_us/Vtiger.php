...
$languageStrings = array(
	...
	'LBL_COMPOSE_EMAIL_WARNING' => ' Warning : Your email might land in spam. Add PraestOs as an authorized sender for your domain. Learn more',
	...
	'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT' => 'For exporting Currency values in Line items, PraestOs will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'LBL_BLANK' => '-Blank-',
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'PraestOs CRM On Demand',
	...
	'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br> PraestOs contacts and Google contacts(in selected group) updated.<br> Click the button to authorize and get Contacts from Google.',
	...
	'TELL_US_ABOUT_YOU_HELP_TEXT_2' => 'The data you submitted here will not be revealed to anyone <Br> outside PraestOs.',
	...
	'LBL_SOCIAL_LINKED' => 'PraestOs is now linked to',
	'LBL_ENTER_KEYWORDS_HELP' => 'PraestOs will scan twitter and find messages with these words',
	...
	'LBL_SHARED_TAGS_ACCESS' => 'Shared tags are accessible by all users in PraestOs',
	...
	'LBL_TIME' => 'Time',
	'LBL_SKIPPED' => 'Skipped',
	'vt_create' => 'Records Created in PraestOs',
	'vt_update' => 'Records Updated in PraestOs',
	'vt_delete' => 'Records Deleted in PraestOs',
	'vt_skip' => 'Records skipped in PraestOs',
	...
	'LBL_SWITCH_TO_VTIGER7_NOW' => 'Switch to PraestOs by Feb 15th',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'This %s cannot be saved since duplicate %s exists in PraestOs with matching values for %s.',
	'LBL_VTIGER_NOTIFICATION' => 'Message from : PraestOs System Notifications',
	...
	'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, PraestOs will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable PraestOs field not available for mapping',
	'JS_MORE_VTIGER' => 'There are more records to be synchronized in PraestOs',
	'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from PraestOs support team',
);
